...
/* harmony import */ var ngx_typed_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ngx-typed-js */ "./node_modules/ngx-typed-js/fesm5/ngx-typed-js.js");
...
var EducationEditComponent = /** @class */ (function () {
    function EducationEditComponent(route, user, router) {
        this.route = route;
        this.user = user;
        this.router = router;
        this.username = this.route.snapshot.params['username'];
    }
    EducationEditComponent.prototype.ngOnInit = function () {
    };
    EducationEditComponent.prototype.UpdateEducation = function (event) {
        var Btech = event.target.querySelector('#Btech').value;
        var twelve = event.target.querySelector('#twelve').value;
        var ten = event.target.querySelector('#ten').value;
        this.user.EditEducaton(Btech, twelve, ten, this.username).subscribe(function (data) {
            console.log(data);
        });
        alert('Education Details Update');
        this.router.navigate(['profile', this.username]);
    };
    EducationEditComponent.ctorParameters = function () { return [
...
var ExperienceEditComponent = /** @class */ (function () {
    function ExperienceEditComponent(route, user, router) {
        this.route = route;
        this.user = user;
        this.router = router;
        this.username = this.route.snapshot.params['username'];
    }
    ExperienceEditComponent.prototype.ngOnInit = function () {
    };
    ExperienceEditComponent.prototype.UpdateExperience = function (event) {
        var _this = this;
        var Company = event.target.querySelector('#Company').value;
        var Role = event.target.querySelector('#Role').value;
        var Locations = event.target.querySelector('#Locations').value;
        var FromDate = event.target.querySelector('#dateOfBirth1').value;
        var ToDate = event.target.querySelector('#dateOfBirth2').value;
        var Description = event.target.querySelector('#Description').value;
        this.user.EditExperience(this.username, Role, Company, Locations, FromDate, ToDate, Description).subscribe(function (data) {
            if (data != null) {
                alert('Experience Added');
                _this.router.navigate(['/profile', _this.username]);
            }
        });
    };
    ExperienceEditComponent.prototype.HomePage = function () {
        return this.router.navigate(['profile', this.username]);
    };
    ExperienceEditComponent.ctorParameters = function () { return [
    ...
    return ExperienceEditComponent;
}());
...
var ProfileService = /** @class */ (function () {
    ...
    ProfileService.prototype.EditExperience = function (username, Role, company, location, from, to, Description) {
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(route, user, router) {
        this.route = route;
        this.user = user;
        this.router = router;
    ...
    ProfileComponent.prototype.LoggingOut = function () {
        this.router.navigate(['']);
    };
    // Get user all details. 
    ProfileComponent.prototype.getProfileUser = function () {
        var _this = this;
        this.user.GetProfile(this.name).subscribe(function (data) {
            _this.UserProfile = data;
        });
    };
    ProfileComponent.prototype.deleteExperience = function (username, company) {
        var _this = this;
        this.user.DeleteExperience(username, company).subscribe(function (data) {
            console.log(data);
            if (data != null)
    ...
    ProfileComponent.prototype.deleteSkills = function (name, skill) {
        var _this = this;
        this.user.DeleteSkill(name, skill).subscribe(function (data) {
            console.log(data);
            if (data != null)
                alert('Deleted');
            _this.ngOnInit();
    ...
    ProfileComponent.prototype.AddSkills = function (name) {
        this.skill = prompt('Skill');
        console.log(name);
        if (this.skill != null) {
            this.user.AddSkill(name, this.skill).subscribe(function (data) {
                console.log(data);
            });
            this.ngOnInit();
        }
    ...
    //Add Project
    ProfileComponent.prototype.AddProject = function (name) {
        return this.router.navigate(['EditProject', name]);
    };
    //Delete Project
    ProfileComponent.prototype.DeleteProject = function (name, title) {
        var _this = this;
        console.log(name);
        console.log(title);
        this.user.DeleteProject(name, title).subscribe(function (data) {
            console.log(data);
            if (data != null)
                alert('Deleted');
            _this.ngOnInit();
    ...
    ProfileComponent.prototype.EditEdu = function (username) {
        return this.router.navigate(['EditBtech', username]);
    };
    ProfileComponent.prototype.AddExperience = function (username) {
        return this.router.navigate(['EditExperience', username]);
    };
    ProfileComponent.prototype.EditTitle = function (username) {
...
var ProjectEditComponent = /** @class */ (function () {
    function ProjectEditComponent(route, user, router) {
        this.route = route;
        this.user = user;
        this.router = router;
        this.username = this.route.snapshot.params['username'];
    ...
    ProjectEditComponent.prototype.AddProject = function (event) {
        var title = event.target.querySelector('#Company').value;
        var Description = event.target.querySelector('#Description').value;
        var URL = event.target.querySelector('#Locations').value;
        console.log(title);
        console.log(Description);
        console.log(URL);
        console.log(this.username);
        this.user.AddProject(this.username, title, Description, URL).subscribe(function (data) {
            console.log(data);
        });
        alert('Project Added');
        this.router.navigate(['profile', this.username]);
    };
    ProjectEditComponent.prototype.HomePage = function () {
        return this.router.navigate(['profile', this.username]);
    };
...
var SearchProfileComponent = /** @class */ (function () {
    function SearchProfileComponent(route, user, router) {
        this.user = user;
        this.router = router;
    ...
    SearchProfileComponent.prototype.getProfileUser = function () {
        var _this = this;
        this.user.SearchUser(this.name).subscribe(function (data) {
            _this.UserProfile = data;
        });
    };
    SearchProfileComponent.prototype.HomePage = function () {
        return this.router.navigate(['']);
    };
    SearchProfileComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _profile_service__WEBPACK_IMPORTED_MODULE_3__["ProfileService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var SignupComponent = /** @class */ (function () {
    function SignupComponent(user, router) {
        this.user = user;
        this.router = router;
    }
    ...
    SignupComponent.prototype.registerUser = function (event) {
        ...
        if (password == cpassword && username != "" && password != "" && cpassword != "") {
            return this.user.RegisterUser(username, password).subscribe(function (data) {
                if (data != null)
...
var StartPageComponent = /** @class */ (function () {
    //public type: any;
    function StartPageComponent(router, user) {
        this.router = router;
        this.user = user;
    }
    ...
    StartPageComponent.prototype.Validate = function (event) {
        var _this = this;
        var username = event.target.querySelector('#loginusername').value;
        var password = event.target.querySelector('#loginpassword').value;
        ...
        this.user.Authenticate(username, password).subscribe(function (data) {
            if (data.success == true)
                return _this.router.navigate(['/profile', username]);
            else
                return alert('Wrong password or username');
        });
    };
    StartPageComponent.prototype.registerUser = function (event) {
        var username = event.target.querySelector('#username').value;
        var password = event.target.querySelector('#password').value;
        var cpassword = event.target.querySelector('#cpassword').value;
        if (password == cpassword && username != "" && password != "" && cpassword != "") {
    ...
    //SignUp process
    StartPageComponent.prototype.SignUp = function () {
        this.router.navigate(['/signup']);
    };
    //Search User 
    StartPageComponent.prototype.Search = function () {
        var _this = this;
        if (!this.name)
            return alert('Write username');
        this.user.SearchTrue(this.name).subscribe(function (data) {
            if (data.searchsuccess)
                return _this.router.navigate(['/searchprofile', _this.name]);
            else
...
var TitleEditComponent = /** @class */ (function () {
    function TitleEditComponent(route, user, router) {
        this.route = route;
        this.user = user;
        this.router = router;
        this.username = this.route.snapshot.params['username'];
    }
    TitleEditComponent.prototype.ngOnInit = function () {
    };
    TitleEditComponent.prototype.UpdateTitle = function (event) {
        var _this = this;
        var Status = event.target.querySelector('#Status').value;
        var Description = event.target.querySelector('#Description').value;
        this.user.EditTitle(this.username, Status, Description).subscribe(function (data) {
            if (data != null) {
                alert('Status Added');
                _this.router.navigate(['/profile', _this.username]);
            }
    ...
    TitleEditComponent.prototype.HomePage = function () {
        return this.router.navigate(['profile', this.username]);
    };
    TitleEditComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _profile_service__WEBPACK_IMPORTED_MODULE_3__["ProfileService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };

...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.EditTitle = function (username) {
        ...
        if (this.status != null) {
            this.user.AddStatus(username, this.status).subscribe(function (data) {
                console.log(data);
            });
            this.ngOnInit();
        }
...
var StartPageComponent = /** @class */ (function () {
    ...
    StartPageComponent.prototype.Validate = function () {
        var _this = this;
        ...
        this.user.Authenticate(this.username, this.password).subscribe(function (data) {
            if (data.success == true)
                return _this.router.navigate(['/profile', _this.username]);
            else
